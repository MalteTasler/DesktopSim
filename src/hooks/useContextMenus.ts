...
import { getViewportSize } from "../utils/layoutDesktopIcons";
...
type UseContextMenusOptions = {
  ...
  pinnedTaskbarApps: string[];
  setPinnedTaskbarApps: Dispatch<SetStateAction<string[]>>;
...
export function useContextMenus({
  ...
  return {
    ...
    showTaskbarAppMenu: (event: MouseEvent, app: DesktopApp) =>
